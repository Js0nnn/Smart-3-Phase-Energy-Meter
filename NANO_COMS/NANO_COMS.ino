...
void loop() {
  ...
  Nano.print(emon0.Irms);          Nano.print("B");
  Nano.print(emon0.apparentPower); Nano.print("C");
  Nano.print(emon0.realPower);     Nano.print("D");
  Nano.print(emon0.powerFactor);   Nano.print("E");
  Nano.print(emon1.Vrms);          Nano.print("F");
  Nano.print(emon1.Irms);          Nano.print("G");
  Nano.print(emon1.apparentPower); Nano.print("H");
  Nano.print(emon1.realPower);     Nano.print("I");
  Nano.print(emon1.powerFactor);   Nano.print("J");
  Nano.print(emon2.Vrms);          Nano.print("K");
  Nano.print(emon2.Irms);          Nano.print("L");
  Nano.print(emon2.apparentPower); Nano.print("M");
  Nano.print(emon2.realPower);     Nano.print("N");
  Nano.print(emon2.powerFactor);   Nano.print("O");
  Nano.print("\n");
